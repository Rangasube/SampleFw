...
import com.crm.qa.testcases.TestClassUsingListeners;
...
public class ExtentListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			extentTest.get().fail("<b><font color-red>"+"Screeshots of Failure" + "</font></b>",MediaEntityBuilder.createScreenCaptureFromPath(path).build());
		}catch(IOException e) {
